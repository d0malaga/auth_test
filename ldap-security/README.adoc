...
The application will be running at the following URL: http://localhost:8080/{artifactId}/. It looks just like the deltaspike app, but uses ldap for the authentication.
